...
String[] messageNames = {"/output_1", "/output_2", "/output_3"}; //message names for each DTW gesture type
String[] messages = {"circle", "chair", "P"};
...
void oscEvent(OscMessage theOscMessage) {
 println("received message", theOscMessage);
 for (int i = 0; i < numClasses; i++) {
